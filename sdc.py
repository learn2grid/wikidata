...
def main():
	...
	for loop in range(10000):
		...
		#queryprefix = '%shaswbstatement:%s -scan -dpla -page -library -bibliotheque -volume -book -pdf -svg -png -ogg -wav -tiff -tif -gif -webp -webm -djvu -djv -mp4 -flac -mp3 -xcf -stl jpg ' % (random.choice(["-", ""]), random.choice(["P1163", "P12120", "P4082", "P7482", "P4082"]))
		queryprefix = '-haswbstatement:P1163 -scan -dpla -page -library -bibliotheque -volume -book -pdf -svg -png -ogg -wav -tiff -tif -gif -webp -webm -djvu -djv -mp4 -flac -mp3 -xcf -stl jpg '
		...
		#trying to boost speed again, added aug 31 2026
		query = '-haswbstatement:P1163 %s -scan -dpla -page -library -bibliotheque -volume -book -pdf -svg -png -ogg -wav -tiff -tif -gif -webp -webm -djvu -djv -mp4 -flac -mp3 -xcf -stl jpg ' % (''.join(random.choice(string.ascii_letters) for xx in range(1)))
